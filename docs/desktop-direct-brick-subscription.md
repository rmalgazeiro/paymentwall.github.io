...
We assume that you have collected [one-time token](/direct/brick/create-form) and [fingerprint](/direct/brick/create-form) on your backend side. You can then use our [Subscription API](/API-Reference#section-brick-subscription) to define subscription for your product.
